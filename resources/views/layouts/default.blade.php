          ...
          <!-- Navbar Right Menu -->
            <div class="navbar-custom-menu">
              <ul class="nav navbar-nav">
                  ...
                  @endcan
                  @can('index', \App\Models\Livetracking::class)
                  <li aria-hidden="true"{!! (Request::is('livetracking*') ? ' class="active"' : '') !!}>
                  <a href="{{ route('livetracking.index') }}" tabindex="-1">
                      <i class="fas fa-tint fa-map"></i>
                      <span class="sr-only">{{ trans('general.livetracking') }}</span>
                  </a>
                  </li>
                  @endcan

                  <li aria-hidden="true"{!! (Request::is('account/view-tickets*') ? ' class="active"' : '') !!}>
                  <a href="{{ route('view-tickets') }}" tabindex="-1">
                      <i class="fas fa-tint fa-ticket"></i>
                      <span class="sr-only">{{ trans('general.ticket') }}</span>
                  </a>
                  </li>
                   ...
                   <ul class="dropdown-menu">
                     @can('create', \App\Models\Asset::class)
                      <li {!! (Request::is('hardware/create') ? 'class="active>"' : '') !!}>
                       ...
                       <li {!! (Request::is('account/create-tickets') ? 'class="active"' : '') !!}>
                           <a href="{{ route('create-tickets') }}" tabindex="-1">
                               <i class="fa fa-ticket fa-fw" aria-hidden="true"></i>
                               {{ trans('general.ticket') }}</a>
                       </li>
                       @endcan
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li{!! (Request::is('consumables*') ? ' class="active"' : '') !!}>
             ...
             @endcan
              @can('view', \App\Models\Livetracking::class)
              <li{!! (Request::is('livetracking*') ? ' class="active"' : '') !!}>
              <a href="{{ route('livetracking.index') }}">
                  <i class="far fa-hdd fa-map"></i>
                  <span>{{ trans('general.livetracking') }}</span>
              </a>
              </li>
              @endcan
             @can('view', \App\Models\Tag::class)
              <li class="treeview {!! in_array(Request::route()->getName(),App\Helpers\Helper::TagUrls()) ? ' active': '' !!}">
                  <a href="#" id="hardware">
                      <i class="fas fa-desktop" aria-hidden="true"></i>
                      <span>{{ trans('general.hardware') }}</span>
                      <i class="fa fa-angle-left pull-right"></i>
                  </a>

                  <ul class="treeview-menu">
                      @if(Gate::allows('view', App\Models\Tag::class) || Gate::allows('view', App\Models\CustomFieldset::class))
                      ...
                      @can('view', \App\Models\Nfc::class)
                      <li {!! (Request::is('nfc*') ? ' class="active"' : '') !!}>
                      <a href="{{ route('tag.index') }}">
                          {{ trans('general.nfc') }}
                      </a>
                      </li>
                      ...
                      @can('view', \App\Models\Biometric::class)
                      <li>
                          <a href="{{ route('tag.index') }}" {{ (Request::is('/assetmodels') ? ' class="active"' : '') }}>
                          {{ trans('general.biometric') }}
                          </a>
                      </li>
                      @endcan
            ...
            @endcan
              ...
              <li{!! (Request::is('account/view-tickets*') ? ' class="active"' : '') !!}>
              <a href="{{ route('view-tickets') }}">
                  <i class="fa fa-ticket fa-fw"></i>
                  <span>{{ trans('general.ticket') }}</span>
              </a>
              </li>
...
<!--                <a target="_blank" class="btn btn-default btn-xs" href="#" rel="noopener">{{ trans('general.bug_report') }}</a>-->
        ...
        @endif
          ...
          <a target="_blank" href="#" rel="noopener">Asset Management System</a> Made with <i class="fas fa-heart" style="color: #a94442; font-size: 10px" aria-hidden="true"></i><span class="sr-only">love</span> by <a href="#" rel="noopener">Us</a>.
      </footer>
