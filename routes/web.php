...
Route::group(['middleware' => 'auth'], function () {
    ...
    * Livetracking
    */
    Route::resource('livetracking', LivetrackingController::class, [
        'parameters' => ['tracking' => 'id'],
    ]);
    /*
    * Livetracking
    */
...
Route::group(['prefix' => 'account', 'middleware' => ['auth']], function () {
    ...
    Route::get('view-tickets', [TicketsController::class, 'getIndex'])->name('view-tickets');
    Route::get('create-tickets', [TicketsController::class, 'getCreateTicket'])->name('create-tickets');
    Route::post('save-ticket', [TicketsController::class, 'postSaveTicket'])->name('save-ticket');
    Route::post('update-ticket', [TicketsController::class, 'postUpdateTicket'])->name('update-ticket');
